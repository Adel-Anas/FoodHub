    ...
    <>
      <div className="Landing-page-container">
        ...
        <div className="Home-Description">
          ...
          <div className="home-page-inputs" data-aos='fade-up' data-aos-delay='500'>
      ...
      <div className="Recipes-Container">
        ...
        <div className="recipes-description" data-aos='fade-up' data-aos-delay='250'>
            <p>
                Excepteur sint occaecat cupidatat non qui proident, sunt culpa qui officia <br /> deserunmollit anim id est laborum.
            </p>
        </div>
        ...
        <div className="NewsLetter" data-aos='fade-in'>
            <div className="NewsLetter-Description">
                ...
                <p>Fusce id velit placerat, efficitur libero placerat, sodales ante. <br /> Curabitur sed erosat orci congue vestibulum.</p>
            </div>
